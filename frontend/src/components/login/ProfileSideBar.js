    ...
    return (
        ...
        <div className="mt-6 bg-white shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
            <div className="space-y-1 pl-8">
                <a href="/compunet1FinalProject/profile" className="relative hover:text-primary block capitalize transition font-medium">
            ...
            <div className="space-y-1 pl-8 pt-4">
                <a href="/compunet1FinalProject/orderHistory" className="relative hover:text-primary block font-medium capitalize transition">
                    <span className="absolute -left-8 top-0 text-base">
